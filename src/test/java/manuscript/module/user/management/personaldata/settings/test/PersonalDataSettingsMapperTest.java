...
public class PersonalDataSettingsMapperTest {
	...
	// authenticatedUser = new AuthenticatedUser("jon", "", "4",
	// getAuthority());
	...
	// academicDisciplines =
	// personalDataSettingsDao.getAcademicDisciplinesByUserId("4");
	...
	// String password =
	// personalDataSettingsDao.getPasswordByUserId(authenticatedUser.getUserId());
	...
	// String password =
	// personalDataSettingsDao.getPasswordByUserId(notPresentUser.getUserId());
	...
	// UpdateAcademicDisciplinesRequest request = new
	// UpdateAcademicDisciplinesRequest();
	// academicDisciplines.clear();
	// academicDisciplines.add(disciplines);
	// request.setAcademicDisciplines(academicDisciplines);
	// personalDataSettingsDao.updateAcademicDisciplinesByUserId(request,
